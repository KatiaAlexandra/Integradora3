...
const getClassroom = async id => {
    await fetch(`http://23.20.208.198:8080/SGI_war/GetClassroomServlet?id=${id}`,{
    method: 'GET',
        headers: {
...
const getUser = async id => {
    await fetch(`http://23.20.208.198:8080/SGI_war/GetUserServlet?id=${id}`,{
    method: 'GET',
        headers: {
        'Accept': 'application/json',
            'Content-Type': 'application/json',
...
const getManager = async id => {
    await fetch(`http://23.20.208.198:8080/SGI_war/GetManagerServlet?id=${id}`,{
    method: 'GET',
        headers: {
        "Accept": "application/json",
            "Content-Type": "application/json",
...
const getArticle = async id => {
    await fetch(`http://23.20.208.198:8080/SGI_war/GetArticleServlet?id=${id}`,{
    method: 'GET',
        headers: {
        "Accept": "application/json",
            "Content-Type": "application/json"
...
const getClassrooms = async () => {
    try {
        const response = await fetch('http://23.20.208.198:8080/SGI_war/GetClassroomsServlet', {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
