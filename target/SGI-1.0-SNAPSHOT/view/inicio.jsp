...
<%
    ...
    String email = request.getSession().getAttribute("user").toString().toLowerCase();
...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <% if (email.equals("20233tn166@utez.edu.mx") || email.equals("katia")) { %>
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <button type="button" class="btn btn-custom-green" data-bs-toggle="modal" data-bs-target="#cambiarContraseña" onclick="llenarDatosUsuario('<%= email %>')">
                                Cambiar contraseña
                            </button>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="cambiarContra">Cambiar contraseña</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<%= context %>/UpdatePasswordServlet" method="post">
                    <label for="nombre">Nombre</label>
                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingrese su nombre"
                    <%--@declare id="emailc"--%><label for="emailC">Correo electrónico</label>
                    <input type="email" class="form-control" name="emailC" id="emailModal" placeholder="Ingrese el correo electrónico" readonly required>
                    <label for="contraseña">Contraseña anterior</label>
                    <input type="password" class="form-control" name="contraseña" id="contraseña" placeholder="Ingrese la contraseña anterior" required>
                    <label for="contraseñaN">Contraseña nueva</label>
                    <input type="password" class="form-control" name="contraseñaN" id="contraseñaN" placeholder="Ingrese la contraseña nueva" required>
                    <div class="d-flex justify-content-end mt-3">
                        <button type="button" class="btn btn-outline-secondary me-2" data-bs-dismiss="modal">Cerrar</button>
                        <button type="submit" class="btn btn-custom-green">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    function llenarDatosUsuario(email) {
